 ...
 */
int
WriteVolume( VectorVolumeType::Pointer &img, const std::string &fname )
{
  itk::ImageFileWriter< VectorVolumeType >::Pointer imgWriter =
    itk::ImageFileWriter< VectorVolumeType >::New();
