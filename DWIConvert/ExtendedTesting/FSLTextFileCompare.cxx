...
int main(int argc, char *argv[])
{
  ...
  std::vector< std::vector<double> > bvecs1, bvecs2;
  std::vector<double> bvals1, bvals2;
  int bVecCount1,bVecCount2;
  ...
  int bValCount1,bValCount2;
  double maxBValue1, maxBValue2;
